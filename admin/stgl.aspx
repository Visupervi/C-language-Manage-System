    ...
    <form id="form1" runat="server">
      ...
      <div class="center clearfix">
        ...
        <div class="main_box fr">
            <div class="main_tit clearfix">内容管理<span>></span>试题管理<span>></span>试题列表管理</div>
            <div class="main_head clearfix">
                <a href="stgl_edit.aspx?c=<%=c%>" class="input_href fr main_head_add">更新题库</a>
                ...
                <asp:Repeater ID="Rep_list" runat="server" onitemcommand="Rep_list_ItemCommand">
                    <ItemTemplate>
                        <ul class="sty2_list clearfix">
                            ...
                            <li class="sty2_lie fr"><a href="stgl_edit.aspx?i=<%#Eval("stID")%>&p=<%=p%>" class="sty2_edit show_add">编辑</a></li>
